...
//provjera da lise dvije lozinke podudaraju: 
UserSchema.methods.comparePasswords = async (password1, password2) => {

  return bcrypt.compare(password1, password2).then(res => res).catch(err => err);
}
UserSchema.methods.comparePasswordsWithoutHash = async (password1, password2) => {
